    ...
    <body style="background-color: beige">
        ...
        <div class=search_header>
        	<form class="form-inline" role="form" >
                    ...
                    <div class="form-group" role="form">
                    <input type="submit" formaction="/dlc/index" class="btn-sm btn-group-toggle" value="Ir a Indexado" style=" background: #ccffcc ;width: 120px; margin: 1em ; font-size: 15px"  >
                    </div>
                    </div>
                    </div>
	        </form>
