        ...
        <div class=search_header>
            <form class="form-inline" role="form" >
                    ...
                    <div class="form-group" role="form"  >
                        <input type="submit" formmethod="post" formaction="/BuscadorDeDocumentosDLC-1.0/index" class="btn-sm btn-group-toggle" value="Cargar Url" style=" align-self: stretch; background: #ccffcc ;width: 120px; margin: 1em 1em ; font-size: 15px">
                    </div>
                    
                    
                    
                    <div class="form-group" role="form" >
                        <input type="submit" formaction="/BuscadorDeDocumentosDLC-1.0/search" class="btn-sm btn-group-toggle" value="Ir a la pagina de busqueda" style=" align-self: stretch; background: #ccffcc ;width: 200px; margin: 1em 1em ; font-size: 15px"> 
                    </div>
